...
// Variables
const rootDomain = "cohixal387.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "pencarigratis"; // Ganti dengan nama workers kalian
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>KAISARVPN👑</span>");
